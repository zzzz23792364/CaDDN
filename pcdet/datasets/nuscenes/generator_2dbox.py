...
def get_2d_boxes(nusc, sample_data_token: str, visibilities: List[str]=['', '1', '2', '3', '4']) -> List[OrderedDict]:
    """
...
def main(args):
    ...
    for token in tqdm(sample_data_camera_tokens):
        reprojection_records = get_2d_boxes(nusc, token, args.visibilities)
